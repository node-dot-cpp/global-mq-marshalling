#ifndef _test_marshalling_h_88ba3f2e_guard
#define _test_marshalling_h_88ba3f2e_guard
...
using aLineMap_Type = NamedParameter<struct aLineMap_Struct>;
using aPoint_Type = NamedParameter<struct aPoint_Struct>;
...
constexpr aLineMap_Type::TypeConverter aLineMap;
constexpr aPoint_Type::TypeConverter aPoint;
...
struct publishable_STRUCT_HtmlTag : public ::globalmq::marshalling::impl::StructType
{
	...
	void compose( ComposerT& composer, const T& t )
	{
		PublishableVectorProcessor::compose<ComposerT, decltype(T::properties), publishable_STRUCT_Property>( composer, t.properties, "properties", false );
...
struct publishable_STRUCT_LineMap : public ::globalmq::marshalling::impl::StructType
{
	...
	void parseForStateSyncOrMessageInDepth( ParserT& parser, T& t )
	{
		::globalmq::marshalling::impl::parseKey( parser, "aLineMap" );
		PublishableVectorProcessor::parse<ParserT, decltype(T::aLineMap), publishable_STRUCT_Line, true>( parser, t.aLineMap );
...
void MESSAGE_point_compose(ComposerT& composer, Args&& ... args)
{
	...
	using arg_1_type = NamedParameterWithType<::globalmq::marshalling::impl::MessageType, aPoint_Type::Name>;
...
structures::infrastructural::MESSAGE_point MESSAGE_point_parse(ParserT& parser)
{
	...
	::globalmq::marshalling::impl::parseStructBegin( parser );
		...
		::globalmq::marshalling::impl::parsePublishableStructBegin( parser, "aPoint" );
		publishable_STRUCT_point::parseForStateSyncOrMessageInDepth( parser, t.aPoint );
		::globalmq::marshalling::impl::parsePublishableStructEnd( parser );
...
void STRUCT_LineMap_compose(ComposerT& composer, Args&& ... args)
{
	...
	using arg_1_type = NamedParameterWithType<::globalmq::marshalling::impl::VectorOfMessageType, aLineMap_Type::Name>;
...
#endif // _test_marshalling_h_88ba3f2e_guard
