...
#define GMQ_SERIALIZE(type__, name__, ref__) comparser.template rw<typename ComparserT::type__>(name__, ref__);
#define GMQ_SERIALIZE_VALUE(type__, ref__) comparser.template rw<typename ComparserT::type__>(ref__);
